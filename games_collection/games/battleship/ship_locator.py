...
class ShipLocator(object):
    def __init__(self, battlefield: Battlefield, ships_locator: ShipsLocator):
        self._battlefield = battlefield
        self._ships_locator = ships_locator

    def locate_ship(self, ship_location: AbstractShipLocation) -> bool:
    ...
    def is_ship_location_inside_battlefield(
        ...
        if not self._battlefield.is_cell_internal(ship_location.left_top_cell):
            return False
